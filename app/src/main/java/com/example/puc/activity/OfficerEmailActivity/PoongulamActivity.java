...
public class PoongulamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_poongulam);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(PoongulamActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);

        ComplaintRecyclerView.setLayoutManager(linearLayoutManager);
        list = new ArrayList<>();
        adapter = new ComplaintsAdapter(PoongulamActivity.this, list);
    ...
    private void getBeemakulam() {
        DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference().child("Complaints").child("Poongulam");
