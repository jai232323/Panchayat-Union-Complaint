...
public class KothakottaiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kothakottai);
        ...
        LinearLayoutManager linearLayoutManager =  new LinearLayoutManager(KothakottaiActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);

        ComplaintRecyclerView.setLayoutManager(linearLayoutManager);
        list = new ArrayList<>();
        adapter = new ComplaintsAdapter(KothakottaiActivity.this,list);
    ...
    private void getBeemakulam() {
        DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference().child("Complaints").child("Kothakottai");
