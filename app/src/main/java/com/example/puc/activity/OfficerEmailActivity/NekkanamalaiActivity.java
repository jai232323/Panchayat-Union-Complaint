...
public class NekkanamalaiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nekkanamalai);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(NekkanamalaiActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);

        ComplaintRecyclerView.setLayoutManager(linearLayoutManager);
        list = new ArrayList<>();
        adapter = new ComplaintsAdapter(NekkanamalaiActivity.this, list);
    ...
    private void getBeemakulam() {
        DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference().child("Complaints").child("Nekkanamalai");
