...
import com.example.puc.activity.OfficersMainActivity;
...
public class BeemakulamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beemakulam);
        ...
        LinearLayoutManager linearLayoutManager =  new LinearLayoutManager(BeemakulamActivity.this);
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);

        ComplaintRecyclerView.setLayoutManager(linearLayoutManager);
        list = new ArrayList<>();
        adapter = new ComplaintsAdapter(BeemakulamActivity.this,list);
    ...
    private void getBeemakulam() {
        DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference().child("Complaints").child("Beemakulam");
